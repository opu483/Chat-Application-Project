...
public class UserOne implements ActionListener, Runnable {
    ...
    UserOne() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/opu.jpg"));
        ...
        p1.add(morevert);
         ...
         emojiButton.setBounds(0, 655, 40, 40);
...
public void actionPerformed(ActionEvent e) {
        ...
        JLabel status = new JLabel("Miftahul, Araf, Nahid, Shanto, Mehrab, Jihad");
