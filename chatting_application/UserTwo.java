...
public class UserTwo implements ActionListener, Runnable {
    ...
    UserTwo() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/himu.png"));
...
public void actionPerformed(ActionEvent e) {
        ...
        JLabel status = new JLabel("Nahid, Miftahul, Araf, Shanto, Mehrab, Jihad");
...
public void sendImage() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                writer.write("IMAGE::" + Base64.getEncoder().encodeToString(imageData));
                writer.write("\r\n");
                writer.flush();
